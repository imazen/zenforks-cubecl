...
pub fn erf<F: Float, N: Size>(x: Vector<F, N>) -> Vector<F, N> {
    ...
    select_many(x.less_than(Vector::new(F::new(0.0f32))), -erf, erf)
}
...
fn erf_positive<F: Float, N: Size>(x: Vector<F, N>) -> Vector<F, N> {
    let p = Vector::new(F::new(0.3275911f32));
    let a1 = Vector::new(F::new(0.2548296f32));
    let a2 = Vector::new(F::new(-0.28449674f32));
    let a3 = Vector::new(F::new(1.4214137f32));
    let a4 = Vector::new(F::new(-1.453152f32));
    let a5 = Vector::new(F::new(1.0614054f32));
    let one = Vector::new(F::new(1.0f32));
